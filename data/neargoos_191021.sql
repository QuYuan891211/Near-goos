...
CREATE TABLE `tab_content_association` (
  ...
  CONSTRAINT `fk_title_content_cid` FOREIGN KEY (`contentid`) REFERENCES `document_content` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `fk_title_content_tid` FOREIGN KEY (`titleid`) REFERENCES `document_tab` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE
...
-- Dump completed on 2019-10-21 14:46:14
